...
fun ProfileScreen(
    ...
    Column(modifier = Modifier
        ...
        Text(text = profile.fullName, style = MaterialTheme.typography.titleMedium, fontSize = 32.sp)
        Text(text = profile.role.russianName, style = MaterialTheme.typography.bodyMedium, fontSize = 22.sp)
